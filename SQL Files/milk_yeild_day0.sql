SELECT * FROM langhillherd.milk_yeild_day0;


update langhillherd.milk_yeild_day0 set MILK_DATE = STR_TO_DATE(MILK_DATE,'%d/%m/%Y %H:%i');
update langhillherd.milk_yeild_day0 set MILK_DATE_MON = STR_TO_DATE(MILK_DATE_MON,'%d/%m/%Y');
update langhillherd.milk_yeild_day0 set MILK_DATE_TUE = STR_TO_DATE(MILK_DATE_TUE,'%d/%m/%Y');
update langhillherd.milk_yeild_day0 set MILK_DATE_WED = STR_TO_DATE(MILK_DATE_WED,'%d/%m/%Y');
update langhillherd.milk_yeild_day0 set MILK_DATE_THU = STR_TO_DATE(MILK_DATE_THU,'%d/%m/%Y');
update langhillherd.milk_yeild_day0 set MILK_DATE_FRI = STR_TO_DATE(MILK_DATE_FRI,'%d/%m/%Y');

update langhillherd.milk_yeild_day0 set DURATION1 = time_to_sec(STR_TO_DATE(DURATION1,'%i:%s'));
update langhillherd.milk_yeild_day0 set DURATION2 = time_to_sec(STR_TO_DATE(DURATION2,'%i:%s'));
update langhillherd.milk_yeild_day0 set DURATION3 = time_to_sec(STR_TO_DATE(DURATION3,'%i:%s'));

update langhillherd.milk_yeild_day0 set REALTIME1 = time_to_sec(STR_TO_DATE(REALTIME1,'%H:%i:%s'));
update langhillherd.milk_yeild_day0 set REALTIME2 = time_to_sec(STR_TO_DATE(REALTIME2,'%H:%i:%s'));
update langhillherd.milk_yeild_day0 set REALTIME3 = time_to_sec(STR_TO_DATE(REALTIME3,'%H:%i:%s'));
...
FROM langhillherd.milk_yeild_day0
group by milk_yeild_day0.MILK_DATE_MON, milk_yeild_day0.MY_EAR_TAG;
...
Group_Concat(DAILY_YEILD),avg(NULLIF(DAILY_YEILD ,0)),std(NULLIF(DAILY_YEILD ,0)),min(DAILY_YEILD),max(DAILY_YEILD),sum(DAILY_YEILD)
FROM langhillherd.milk_yeild_day0
group by milk_yeild_day0.MILK_DATE_TUE, milk_yeild_day0.MY_EAR_TAG;
...
Group_Concat(DAILY_YEILD),avg(NULLIF(DAILY_YEILD ,0)),std(NULLIF(DAILY_YEILD ,0)),min(DAILY_YEILD),max(DAILY_YEILD),sum(DAILY_YEILD)
FROM langhillherd.milk_yeild_day0
group by milk_yeild_day0.MILK_DATE_WED, milk_yeild_day0.MY_EAR_TAG;
...
Group_Concat(DAILY_YEILD),avg(NULLIF(DAILY_YEILD ,0)),std(NULLIF(DAILY_YEILD ,0)),min(DAILY_YEILD),max(DAILY_YEILD),sum(DAILY_YEILD)
FROM langhillherd.milk_yeild_day0
group by milk_yeild_day0.MILK_DATE_THU, milk_yeild_day0.MY_EAR_TAG;
...
Group_Concat(DAILY_YEILD),avg(NULLIF(DAILY_YEILD ,0)),std(NULLIF(DAILY_YEILD ,0)),min(DAILY_YEILD),max(DAILY_YEILD),sum(DAILY_YEILD)
FROM langhillherd.milk_yeild_day0
group by milk_yeild_day0.MILK_DATE_FRI, milk_yeild_day0.MY_EAR_TAG;